...
2. **DNS** — point lightyeardata.com at GitHub Pages (A records `185.199.108.153`, `.109.153`, `.110.153`, `.111.153`; `www` CNAME to `chris-lyd.github.io`, replacing any default `www` record the registrar added), then set the custom domain in repo Settings → Pages and enable Enforce HTTPS.
